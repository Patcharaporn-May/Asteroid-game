...
public class ImageFilePaths {
    public static final String BACKGROUND = "assets/Images/Backgrounds/newbackground.png";
    public static final String PLAYER_ONE_SPRITE = "assets/Images/Sprites/Player/playerShip3_red.png";
    public static final String PLAYER_TWO_SPRITE = "assets/Images/Sprites/Player/playerShip3_blue.png";
    public static final String PLAYER_THREE_SPRITE = "assets/Images/Sprites/Player/playerShip3_green.png";
    public static final String PLAYER_FOUR_SPRITE = "assets/Images/Sprites/Player/playerShip3_orange.png";
    ...
    public static final String GAMEOVER = "assets/Images/Backgrounds/gameover.jpg";
}
